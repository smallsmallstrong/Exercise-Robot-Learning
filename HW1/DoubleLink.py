...
class DoubleLink():
    def __init__(self):
        # Set the K gains 2x3 matrix, raw one for first joint, raw two for second joint
        # self.PDGains = np.array([[60, 10, 0.1], [30, 6, 0.1]])
        self.PDGains = []
        # Set the x_end = (-0.35, 1.5)
        # self.PDSetPoints = np.array([-0.35, 1.5])
        self.PDSetPoints = []
